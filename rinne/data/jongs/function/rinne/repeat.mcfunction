...
execute as @e[type=minecraft:spectral_arrow,tag=jongs.rinne.magic_arrow,predicate=jongs:rinne/thrown/too_slow] at @s run function jongs:rinne/use_item/on_mainhand/sword/remove