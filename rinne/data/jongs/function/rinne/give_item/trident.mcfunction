...
minecraft:enchantments={"minecraft:sharpness":3,"minecraft:riptide":3,"minecraft:looting":3,"minecraft:breach":7,"minecraft:vanishing_curse":1},\
minecraft:use_effects={can_sprint:true,speed_multiplier:0.15},\
