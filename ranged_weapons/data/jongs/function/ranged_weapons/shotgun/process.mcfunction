$execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[dx=0,nbt=!{UUID:$(UUID)},type=!#jongs:ranged_weapons/infinite_health,predicate=jongs:ranged_weapons/not_invulnerable] positioned ~0.5 ~0.5 ~0.5 run function jongs:ranged_weapons/shotgun/success with storage jongs:ranged_weapons
