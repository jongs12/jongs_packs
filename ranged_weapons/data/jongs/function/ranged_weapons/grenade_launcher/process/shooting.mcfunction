...
$execute store success score @s jongs.ranged_weapons.success positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,nbt=!{UUID:$(shooter)},type=!#jongs:ranged_weapons/infinite_health] run damage @s 24 minecraft:player_explosion by @p[nbt={UUID:$(shooter)}]
