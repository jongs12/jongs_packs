...
execute if score @s jongs.ranged_weapons.distance matches 1.. positioned ^ ^ ^ run return run function jongs:ranged_weapons/grenade_launcher/process/shooting with entity @s data.jongs[{purpose:"ranged_weapons.shot_rocket"}]
...
return run particle minecraft:cloud ~ ~ ~ 0.1 0.1 0.1 0 1 normal