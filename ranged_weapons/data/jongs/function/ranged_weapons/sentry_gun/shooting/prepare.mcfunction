...
execute store success score @s jongs.ranged_weapons.success as @e[distance=..25,tag=!jongs.ranged_weapons.shooter,type=!#jongs:ranged_weapons/no_throwable_target,limit=1] run tag @s add jongs.ranged_weapons.target
...
scoreboard players set @s jongs.ranged_weapons.success 0
execute store success score @s jongs.ranged_weapons.success as @e[distance=..25,tag=!jongs.ranged_weapons.shooter,type=!#jongs:ranged_weapons/no_throwable_target,tag=!jongs.ranged_weapons.blocked,limit=1] run tag @s add jongs.ranged_weapons.target
