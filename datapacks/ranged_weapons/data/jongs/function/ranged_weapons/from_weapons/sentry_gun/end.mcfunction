...
tag @e[type=!#jongs:ranged_weapons/throwables_dont_target,tag=!jongs.ranged_weapons.shooter,tag=jongs.ranged_weapons.wont_target] remove jongs.ranged_weapons.wont_target
...
return run scoreboard players set @s jongs.ranged_weapons.delay 24