advancement revoke @s only jongs:ranged_weapons/shooting/bullet
...
return run function jongs:ranged_weapons/shooting/bullet/start with entity @s SelectedItem.components."minecraft:custom_data".jongs[{"purpose":"ranged_weapons.guns"}]