...
execute unless score @s jongs.ranged_weapons.cooldown.sentry_gun matches 0 run return 0
item modify entity @s weapon.mainhand {"function":"set_damage","add":true,"damage":-0.3}
