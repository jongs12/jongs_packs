...
Health:100,profile:{texture:"block/blackstone"},pose:"crouching",immovable:false,hide_description:true,Passengers:[{id:"minecraft:block_display",block_state:{id:"minecraft:grindstone"},brightness:{block:3,sky:15}, \
