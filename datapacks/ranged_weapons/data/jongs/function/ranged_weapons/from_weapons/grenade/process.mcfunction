...
execute unless block ^ ^ ^0.9 #jongs:ranged_weapons/dashable run return run function jongs:ranged_weapons/from_weapons/grenade/explosion with storage jongs:ranged_weapons rocket.area
