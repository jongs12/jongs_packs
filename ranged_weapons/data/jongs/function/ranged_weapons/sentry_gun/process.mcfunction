...
execute if score @s jongs.ranged_weapons.distance matches 8 run return run function jongs:ranged_weapons/sentry_gun/shooting/prepare
execute if score @s jongs.ranged_weapons.distance matches 10 if score @s jongs.ranged_weapons.success matches 0 run return run scoreboard players set @s jongs.ranged_weapons.distance 0
