...
execute if score @s jongs.ranged_weapons.cooldown.energy_shield matches 1 run particle minecraft:trial_spawner_detection_ominous ~ ~0.5 ~ 0.5 0.5 0.5 0.1 20
