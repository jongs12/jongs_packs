...
scoreboard players set @s jongs.ranged_weapons.cooldown.sniper_rifle 24
scoreboard players set @s jongs.ranged_weapons.distance -600
playsound minecraft:entity.iron_golem.death player @a ~ ~ ~ 3 0.8
execute anchored eyes positioned ^ ^ ^ anchored feet run function jongs:ranged_weapons/sniper_rifle/process
