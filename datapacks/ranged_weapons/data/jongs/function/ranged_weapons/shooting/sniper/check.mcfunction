advancement revoke @s only jongs:ranged_weapons/shooting/sniper
...
return run function jongs:ranged_weapons/shooting/sniper/start with entity @s SelectedItem.components."minecraft:custom_data".jongs[{"purpose":"ranged_weapons.guns"}]