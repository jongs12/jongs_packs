execute positioned ~-1 ~-1 ~-1 as @e[dx=1,dy=1,dz=1,type=!#jongs:ranged_weapons/throwables_dont_target,tag=!jongs.ranged_weapons.shooter,tag=!jongs.ranged_weapons.do_not_target,limit=1] run return run function jongs:ranged_weapons/from_weapons/sentry_gun/damage
execute unless loaded ^ ^ ^1 run return 0
execute unless block ^ ^ ^0.75 #jongs:ranged_weapons/can_pierce run return 0
