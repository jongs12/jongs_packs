...
summon minecraft:block_display ~ ~ ~ {Tags:["jongs.orbital_strike.summoned","jongs.orbital_strike.limit_duration"],Rotation:[0,-90],block_state:{Name:red_stained_glass},brightness:{block:15,sky:0},transformation:{right_rotation:[0,0,0,1],scale:[0.6,0.6,200],left_rotation:[0,0,0,1],translation:[-0.3,-0.3,-15]}}
summon minecraft:block_display ~ ~ ~ {Tags:["jongs.orbital_strike.summoned","jongs.orbital_strike.limit_duration","jongs.orbital_strike.rotate"],Rotation:[0,-90],block_state:{Name:sea_lantern},teleport_duration:1,brightness:{block:15,sky:0},transformation:{right_rotation:[0,0,0,1],scale:[0.3,0.3,200],left_rotation:[0,0,0,1],translation:[-0.15,-0.15,-15]}}
summon minecraft:block_display ~ ~360 ~ {Tags:["jongs.orbital_strike.summoned","jongs.orbital_strike.limit_duration","jongs.orbital_strike.drop"],Rotation:[45,90],block_state:{Name:netherite_block},teleport_duration:1,brightness:{block:0,sky:15},transformation:{right_rotation:[0,0,0,1],scale:[0.6,0.6,3],left_rotation:[0,0,0,1],translation:[-0.3,-0.3,-1.5]}}
