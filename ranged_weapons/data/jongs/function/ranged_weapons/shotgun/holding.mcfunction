...
execute if score @s jongs.ranged_weapons.reload matches 3001 run item modify entity @s weapon.mainhand jongs:ranged_weapons/fully_loaded
execute if score @s[predicate=!jongs:ranged_weapons/can_shoot] jongs.ranged_weapons.reload matches 3000..3999 run return run scoreboard players remove @s jongs.ranged_weapons.reload 1
