execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!jongs.ranged_weapons.loaded,type=!#jongs:ranged_weapons/infinite_health] run function jongs:ranged_weapons/assault_rifle/damage
