...
execute store result score #추가값 jongs.sword_dash.click run data get entity @n[predicate=jongs:sword_dash/is_wind_charge] Item.count 5
...
kill @n[predicate=jongs:sword_dash/is_wind_charge]
