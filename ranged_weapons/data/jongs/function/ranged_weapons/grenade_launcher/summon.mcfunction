$summon minecraft:snowball ^ ^ ^0.5 {Motion:[$(x),$(y),$(z)],Item:{id:fire_charge},Passengers:[{id:"minecraft:marker",Tags:["jongs.ranged_weapons.summoned","jongs.ranged_weapons.shot_grenade"]}]}
