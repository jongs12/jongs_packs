...
\
minecraft:attribute_modifiers=[{amount:7.0d,id:"jongs:rinne.mainhand.attack_damage",slot:"mainhand",type:"minecraft:attack_damage",operation:"add_value"},{amount:4.0d,id:"jongs:rinne.mainhand.attack_speed",slot:"mainhand",type:"minecraft:attack_speed",operation:"add_multiplied_base"}],\
minecraft:attack_range={max_reach:9,max_creative_reach:9,hitbox_margin:0.5},\
minecraft:enchantments={"minecraft:sharpness":3,"minecraft:smite":4,"minecraft:impaling":4,"minecraft:riptide":3,"minecraft:looting":3,"minecraft:breach":7,"minecraft:vanishing_curse":1},\
minecraft:use_effects={can_sprint:true,speed_multiplier:0.3},\
