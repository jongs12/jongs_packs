...
execute as @a if score @s jongs.ranged_weapons.cooldown.assault_rifle matches 1 run advancement revoke @s only jongs:ranged_weapons/shoot/assault_rifle
execute as @a if score @s jongs.ranged_weapons.cooldown.assault_rifle matches 1.. run scoreboard players remove @s jongs.ranged_weapons.cooldown.assault_rifle 1