...
execute store success score @s jongs.ranged_weapons.success positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!jongs.ranged_weapons.shooter,type=!#jongs:ranged_weapons/no_explosion_target] run damage @s 50 minecraft:player_attack by @p[tag=jongs.ranged_weapons.shooter]
...
execute positioned ^ ^ ^0.5 store success score @s jongs.ranged_weapons.success positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!jongs.ranged_weapons.shooter,type=!#jongs:ranged_weapons/no_explosion_target] run damage @s 50 minecraft:player_attack by @p[tag=jongs.ranged_weapons.shooter]
execute if score @s jongs.ranged_weapons.success matches 0.. run return run function jongs:ranged_weapons/rocket_launcher/explosion
execute positioned ^ ^ ^1 unless loaded ^ ^ ^1 run return run function jongs:ranged_weapons/rocket_launcher/explosion
execute positioned ^ ^ ^1 store success score @s jongs.ranged_weapons.success positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!jongs.ranged_weapons.shooter,type=!#jongs:ranged_weapons/no_explosion_target] run damage @s 50 minecraft:player_attack by @p[tag=jongs.ranged_weapons.shooter]
execute if score @s jongs.ranged_weapons.success matches 0.. run return run function jongs:ranged_weapons/rocket_launcher/explosion
...
execute positioned ^ ^ ^1.5 store success score @s jongs.ranged_weapons.success positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!jongs.ranged_weapons.shooter,type=!#jongs:ranged_weapons/no_explosion_target] run damage @s 50 minecraft:player_attack by @p[tag=jongs.ranged_weapons.shooter]
execute if score @s jongs.ranged_weapons.success matches 0.. run return run function jongs:ranged_weapons/rocket_launcher/explosion
