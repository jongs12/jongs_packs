...
execute unless block ^ ^ ^ #jongs:ranged_weapons/dashable run return run function jongs:ranged_weapons/shooting/saw/break
...
execute unless block ^ ^ ^1 #jongs:ranged_weapons/dashable positioned ^ ^ ^1 run return run function jongs:ranged_weapons/shooting/saw/break
...
execute unless block ^ ^ ^2 #jongs:ranged_weapons/dashable positioned ^ ^ ^2 run return run function jongs:ranged_weapons/shooting/saw/break
