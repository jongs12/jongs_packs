...
return run title @s actionbar {"translate":"jongs.rinne.time_left","color":"light_purple","shadow_color":[0,0,0,1],"with":[{"score":{"name":"#현재값","objective":"jongs.rinne.remaining"},"color":"yellow","bold":true,"shadow_color":[0,0,0,1]}]}