...
$execute unless entity @s[gamemode=creative] unless entity @s[level=$(level_need)..] run return run title @s actionbar {"translate":"jongs.ranged_weapons.canceled","color":"#FFAAAA","shadow_color":[0,0,0,1],"with":["$(level_need)"]}
