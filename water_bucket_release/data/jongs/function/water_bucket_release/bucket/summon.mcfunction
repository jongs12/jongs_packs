$summon minecraft:snowball ~ ~ ~ {Owner:$(UUID),Motion:[$(x),$(y),$(z)],Item:{id:water_bucket,components:{enchantment_glint_override:true}},Tags:["jongs_water_bucket_release_throw"]}
