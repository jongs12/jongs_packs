item modify entity @s weapon.mainhand {"type":"minecraft:set_components","components":{"minecraft:repair_cost":0}}
execute if items entity @s weapon.mainhand *[max_damage=1,damage~{durability:0}] run item modify entity @s weapon.mainhand {"type":"minecraft:set_count","count":-1,"add":true}
