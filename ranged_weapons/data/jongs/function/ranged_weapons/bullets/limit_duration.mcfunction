...
execute as @s[type=minecraft:block_display] run return run function jongs:ranged_weapons/rocket_launcher/process with entity @s data.jongs[{purpose:"ranged_weapons.shot_rocket"}]
