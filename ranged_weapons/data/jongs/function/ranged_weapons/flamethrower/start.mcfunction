...
summon minecraft:marker ^ ^ ^2 {Tags:["jongs.ranged_weapons.motion"]}
execute as @e[type=minecraft:marker,tag=jongs.ranged_weapons.motion,limit=1] run function jongs:ranged_weapons/flamethrower/set_motion
...
execute anchored eyes positioned ^ ^ ^ anchored feet run return run function jongs:ranged_weapons/flamethrower/summon with storage jongs:ranged_weapons