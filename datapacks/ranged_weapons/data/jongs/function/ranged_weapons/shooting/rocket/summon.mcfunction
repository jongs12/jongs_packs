$summon minecraft:block_display ^ ^ ^ {data:{jongs:[{purpose:"ranged_weapons.from_weapons",path:"rocket"}]},Tags:["jongs.ranged_weapons.summoned","jongs.ranged_weapons.from_weapons"],block_state:{id:"$(block_name)"},\
