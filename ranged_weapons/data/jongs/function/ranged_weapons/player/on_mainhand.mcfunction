execute as @s[predicate=jongs:ranged_weapons/holding_assault_rifle] run function jongs:ranged_weapons/assault_rifle/holding
execute as @s[predicate=jongs:ranged_weapons/holding_pistol] run function jongs:ranged_weapons/pistol/holding
execute as @s[predicate=jongs:ranged_weapons/holding_shotgun] run function jongs:ranged_weapons/shotgun/holding
