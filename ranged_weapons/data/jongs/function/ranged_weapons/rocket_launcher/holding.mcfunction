execute if score @s jongs.ranged_weapons.reload matches 6063 run title @s actionbar {"translate":"jongs.ranged_weapons.reloading","color":"#AA5555"}
execute if score @s jongs.ranged_weapons.reload matches 6062 run playsound minecraft:entity.ender_dragon.hurt player @a ~ ~ ~ 1.5 0.6
...
execute as @s[predicate=!jongs:ranged_weapons/can_shoot] run return run scoreboard players set @s jongs.ranged_weapons.reload 6063
