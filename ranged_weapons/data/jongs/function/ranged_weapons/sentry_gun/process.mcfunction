...
execute if score @s jongs.ranged_weapons.distance matches 5 unless score @s jongs.ranged_weapons.success matches 1 run return run function jongs:ranged_weapons/sentry_gun/shooting/rotate
