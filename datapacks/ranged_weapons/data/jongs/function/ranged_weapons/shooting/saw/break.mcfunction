...
item modify entity @s weapon.mainhand {"type":"minecraft:set_damage","damage":-0.01,"add":true}
...
execute if block ^ ^ ^ #jongs:ranged_weapons/saw/more_damage run item modify entity @s weapon.mainhand {"type":"minecraft:set_damage","damage":-0.065,"add":true}
