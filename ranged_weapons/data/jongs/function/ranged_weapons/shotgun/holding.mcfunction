execute if score @s jongs_ranged_weapons_reload matches 3051 run title @s actionbar {"translate":"jongs.ranged_weapons.reloading","color":"dark_red"}
execute if score @s jongs_ranged_weapons_reload matches 3050 run playsound minecraft:block.chain.place player @a ~ ~ ~ 1.5 0.8
...
execute as @s[predicate=!jongs:ranged_weapons/can_shoot] run return run scoreboard players set @s jongs_ranged_weapons_reload 3051
