$execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,nbt=!{UUID:$(UUID)},type=!#jongs:ranged_weapons/infinite_health] store success score #엔티티감지 jongs.ranged_weapons.success run scoreboard players add @s jongs.ranged_weapons.hit 6
