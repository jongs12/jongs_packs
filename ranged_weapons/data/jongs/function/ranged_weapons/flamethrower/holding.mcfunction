execute if score @s jongs.ranged_weapons.reload matches 5059 run title @s actionbar {"translate":"jongs.ranged_weapons.reloading","color":"gray"}
execute if score @s jongs.ranged_weapons.reload matches 5058 run playsound minecraft:block.fire.extinguish player @a ~ ~ ~ 1.5 0.8
...
execute as @s[predicate=!jongs:ranged_weapons/can_shoot] run return run scoreboard players set @s jongs.ranged_weapons.reload 5059