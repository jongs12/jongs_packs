...
minecraft:blocks_attacks={block_delay_seconds:0,disable_cooldown_scale:0,damage_reductions:[{type:"#jongs:rinne/all",base:0,factor:0.8,horizontal_blocking_angle:120}],item_damage:{threshold:0,base:0,factor:0},block_sound:{sound_id:"minecraft:block.amethyst_cluster.place"}}\
]