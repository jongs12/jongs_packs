...
$execute positioned ~-3.5 ~-3.5 ~-3.5 as @e[dx=6,dy=6,dz=6,nbt=!{UUID:$(UUID)},type=!#jongs:ranged_weapons/no_explosion_target] run damage @s 26 minecraft:player_explosion by @e[type=minecraft:item_display,limit=1,tag=jongs.ranged_weapons.exploding] from @p[nbt={UUID:$(UUID)}]
