...
execute if score #짝수확인 jongs.ranged_weapons.distance matches 2 unless block ~ ~ ~ #jongs:ranged_weapons/sniper_can_pierce run return run particle minecraft:block{block_state:{Name:"minecraft:netherite_block"}} ~ ~ ~ 0.1 0.1 0.1 1 3 normal
