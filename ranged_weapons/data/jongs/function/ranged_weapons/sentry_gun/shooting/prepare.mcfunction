...
scoreboard players set @s jongs.ranged_weapons.distance 32
...
particle minecraft:block{block_state:{Name:"minecraft:grindstone"}} ~ ~ ~ 0.2 0.2 0.2 1 5
execute positioned ^ ^ ^ run function jongs:ranged_weapons/sentry_gun/shooting/in_progress
