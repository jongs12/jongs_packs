execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[dx=0,tag=!jongs.ranged_weapons.loaded,type=!#jongs:ranged_weapons/no_bullet_target] store success score #엔티티감지 jongs.ranged_weapons.success run scoreboard players add @s jongs.ranged_weapons.hit 6
