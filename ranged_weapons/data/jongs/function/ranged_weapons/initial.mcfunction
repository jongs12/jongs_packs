...
scoreboard players set #거리제한.assault_rifle jongs.ranged_weapons.distance -200
scoreboard players set #거리제한.pistol jongs.ranged_weapons.distance -160
scoreboard players set #거리제한.shotgun jongs.ranged_weapons.distance -80
scoreboard players set #거리제한.sniper_rifle jongs.ranged_weapons.distance -600
scoreboard objectives add jongs.ranged_weapons.reload dummy
scoreboard objectives add jongs.ranged_weapons.loaded dummy
