$execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[dx=0,nbt=!{UUID:$(UUID)},type=!#jongs:ranged_weapons/sniper_infinite_health] run function jongs:ranged_weapons/sniper_rifle/success with entity @s
