execute positioned ~-1 ~-1 ~-1 as @e[dx=1,dy=1,dz=1,tag=!jongs.ranged_weapons.shooter,type=!#jongs:ranged_weapons/no_throwable_target] run function jongs:ranged_weapons/sentry_gun/shooting/damage {damage:5.5}
