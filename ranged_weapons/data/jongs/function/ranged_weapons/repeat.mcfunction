...
execute as @e[type=minecraft:item_display,tag=jongs.ranged_weapons.limit_duration] at @s run function jongs:ranged_weapons/sticky_mine/process with entity @s data.jongs[{purpose:"ranged_weapons.thrown_mine"}]