...
$execute positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[dx=0,nbt=!{UUID:$(UUID)},limit=1] run return run function jongs:raycasting/rangefinder/success_entity with entity @s
